...
const Certifications = () => {
  ...
  flex flex-col flex-wrap lg:mb-35 pt-5 md:pt-20 pb-10 md:pb-20' id='certifications'>
  <motion.h2
  ...
  <div className='flex flex-wrap justify-center items-center gap-4 gap-y-10 md:gap-y-20 sm:gap-x-20 mt-9 p-10'>
    {
        certificationData.map((certification,id)=>{
            ...
            className='flex flex-col items-center justify-center shadow-2xl pb-6 rounded-xl'>
                <div
