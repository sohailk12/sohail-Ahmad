...
const Certifications = () => {
  return <section className='border-b-2 border-solid border-slate-200 ml-5 md:ml-56 mr-5 flex flex-col flex-wrap lg:mb-35 py-20' id='certifications'>
  <motion.h2
  ...
  <div className='flex flex-wrap justify-center items-center gap-4 gap-y-20 sm:gap-x-20 mt-9 p-10'>
    {
        certificationData.map((certification,id)=>{
            return <div key={id} className='flex flex-col items-center justify-center shadow-2xl pb-6 rounded-xl'>
                ...
                className='flex flex-wrap justify-center items-center md:border-b-2 md:border-sky-300 py-1 w-fit mb-5 ml-1'>
                <IoIosRibbon className='text-3xl mt-0 text-sky-950'/>
                <h2 className='text-xl text-sky-900 font-semibold tracking-tight mr-6'>
                    {certification.title}
                </h2>
                <motion.div 
