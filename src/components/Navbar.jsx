...
useEffect(()=>{
  ...
  className='w-11/12 md:w-56 pt-6 md:bg-gradient-to-r from-purple-200 via-indigo-100 to-sky-200 md:block left-5 md:left-0 right-5 md:right-0 relative md:fixed top-0 md:px-1'>
