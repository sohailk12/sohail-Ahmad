    ...
    <ul className='flex flex-col gap-y-4'>
        {
            sections.map((section,id)=>{
                return <li key={id} className='flex flex-row group '>
                        ...
                        <div className={`${activeSection === section.id ? 'border-t-2 border-violet-700 lg:w-14':'border-t-2 border-sky-900'} w-6 mt-4 transition-all group-hover:w-14 group-hover:border-violet-700`}></div>
